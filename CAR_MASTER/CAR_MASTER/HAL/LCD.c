...
void LCD_Diplay_Car_Management(u8 order)
{
	if(order=='z') //door1
	{
		LCD_GoTo(1,11);
		LCD_WriteString("D1 Active");
	}
	else if(order=='x')//door2
	{
		LCD_GoTo(1,11);
		LCD_WriteString("D2 Active");
	}
	else if(order=='a')//door3
	{
		LCD_GoTo(1,11);
		LCD_WriteString("D3 Active");
	}
	else if(order=='s')//door4
	{
		LCD_GoTo(1,11);
		LCD_WriteString("D4 Active");
	}
	else if(order=='q')//DC motoor full speed
	{
		LCD_GoTo(2,11);
		LCD_WriteString("     ");
		LCD_GoTo(2,11);
